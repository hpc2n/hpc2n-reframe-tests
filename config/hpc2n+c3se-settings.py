            ...
            'partitions': [
                {
                    ...
                    'environs': ['builtin', 'gnu', 'foss', 'foss+cuda', 'fosscuda', 'fosscuda_2019b', 'fosscuda_2020a', 'fosscuda_2020b', 'foss_2021a', 'intelcuda_2019b', 'intelcuda_2020a', 'intelcuda_2020b'],
                    'resources': [
                        {
                            'name': '_rfm_gpu',
            ...
            'partitions': [
                {
                    ...
                    'scheduler': 'local',
                    'launcher': 'local',
                    'environs': ['builtin', 'gnu', 'foss', 'intel', 'foss_2019a', 'foss_2019b', 'foss_2020a', 'foss_2020b', 'foss_2021a', 'intel_2019a', 'intel_2019b', 'intel_2020a', 'intel_2020b', 'intel_2021a'],
                    'container_platforms': [
                        {
                            'type': 'Singularity',
                            'modules': ['singularity'],
                ...
                },
                {
                    ...
                    'environs': ['builtin', 'gnu', 'foss', 'intel', 'foss+cuda', 'fosscuda', 'foss_2019a', 'foss_2019b', 'foss_2020a', 'foss_2020b', 'foss_2021a', 'intel_2019a', 'intel_2019b', 'intel_2020a', 'intel_2020b', 'intel_2021a'],
                    'container_platforms': [
                        {
                            'type': 'Singularity',
                            'modules': ['singularity'],
